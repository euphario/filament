...
pub fn dump_register_map() {
    libsys::println!("=== MT7996 Register Map ===");
    libsys::println!("WFDMA0_BASE:        0x{:05x}", wfdma0::BASE);
    libsys::println!("WFDMA0_RST:         0x{:05x}", wfdma0::RST);
    libsys::println!("WFDMA0_GLO_CFG:     0x{:05x}", wfdma0::GLO_CFG);
    libsys::println!("WFDMA0_RST_DTX_PTR: 0x{:05x}", wfdma0::RST_DTX_PTR);
    libsys::println!("PAUSE_RX_Q_45_TH:   0x{:05x}", wfdma0::PAUSE_RX_Q_45_TH);
    libsys::println!("PAUSE_RX_Q_67_TH:   0x{:05x}", wfdma0::PAUSE_RX_Q_67_TH);
    libsys::println!("PAUSE_RX_Q_89_TH:   0x{:05x}", wfdma0::PAUSE_RX_Q_89_TH);
    libsys::println!("PAUSE_RX_Q_RRO_TH:  0x{:05x}", wfdma0::PAUSE_RX_Q_RRO_TH);
    libsys::println!("GLO_CFG_EXT0:       0x{:05x}", wfdma0::GLO_CFG_EXT0);
    libsys::println!("GLO_CFG_EXT1:       0x{:05x}", wfdma0::GLO_CFG_EXT1);
    libsys::println!("");
    libsys::println!("WFDMA0_PCIE1_BASE:  0x{:05x}", wfdma0_pcie1::BASE);
    libsys::println!("HIF1_OFS:           0x{:05x}", wfdma0_pcie1::HIF1_OFS);
    libsys::println!("");
    libsys::println!("EXT_CSR_BASE:       0x{:05x}", wfdma_ext_csr::BASE);
    libsys::println!("EXT_CSR_HIF_MISC:   0x{:05x}", wfdma_ext_csr::HIF_MISC);
    libsys::println!("");
    libsys::println!("=== Queue Prefetch Control ===");
    libsys::println!("FWDL ext_ctrl:      0x{:05x}", queue::mcuq_ext_ctrl(queue::mcuq::FWDL));
    libsys::println!("WM ext_ctrl:        0x{:05x}", queue::mcuq_ext_ctrl(queue::mcuq::WM));
    libsys::println!("WA ext_ctrl:        0x{:05x}", queue::mcuq_ext_ctrl(queue::mcuq::WA));
    libsys::println!("BAND0 ext_ctrl:     0x{:05x}", queue::txq_ext_ctrl(queue::txq::BAND0));
    libsys::println!("BAND1 ext_ctrl:     0x{:05x}", queue::txq_ext_ctrl(queue::txq::BAND1));
    libsys::println!("BAND2 ext_ctrl:     0x{:05x}", queue::txq_ext_ctrl(queue::txq::BAND2));
    libsys::println!("");
    libsys::println!("=== Ring Bases ===");
    libsys::println!("FWDL ring_base:     0x{:05x}", queue::mcuq_ring_base(queue::mcuq::FWDL));
    libsys::println!("WM ring_base:       0x{:05x}", queue::mcuq_ring_base(queue::mcuq::WM));
    libsys::println!("BAND0 ring_base:    0x{:05x}", queue::txq_ring_base(queue::txq::BAND0));
}
